 ...
 */
$messages['ja'] = array(
	'createbox-desc' => 'ページ作成に特化した入力ボックス',
	'createbox-create' => '作成',
	'createbox-exists' => "残念ながら「'''{{FULLPAGENAME}}'''」は既に存在します。

このページの作成はできませんが、[{{fullurl:{{FULLPAGENAME}}|action=edit}} 同名のページを編集]、[{{fullurl:{{FULLPAGENAME}}}} 閲覧]、または以下のBoxを使用して他の名前のページを作成できます。
 ...
 */
$messages['ko'] = array(
	'createbox-desc' => '새 문서 만들기를 편리하게 만들어 주는 입력 상자',
	'createbox-create' => '만들기',
...
$messages['ta'] = array(
	...
	'createbox-exists' => "மன்னிக்கவும், \"'''{{FULLPAGENAME}}'''\" ஏற்கனவே உள்ளது.

இந்தப் பக்கத்தை உருவாக்க இயலாது, ஆனால் நீங்கள் [{{fullurl:{{FULLPAGENAME}}|action=edit}} இதை தொகுக்கலாம்], [{{fullurl:{{FULLPAGENAME}}}}படிக்கலாம்], அல்லது கீழேயுள்ள பெட்டியைப் பயன்படுத்தி வேறு பக்கத்தை உருவாக்கத் தேர்ந்த்தேடுக்கவும்.
